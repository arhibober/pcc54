...
background-color: #295e9c;
					...
					<?php if ( !empty( $settings['register'] ) || !empty( $settings['lostpass'] ) ) : ?>
						...
						<div class="bbp-login-links">
							...
							<?php if ( !empty( $settings['register'] ) ) : ?>
								...
								<a href="http://localhost/pcc54/wp-login.php?action=register" title="<?php esc_attr_e( 'Register', 'bbpress' ); ?>" class="bbp-register-link"><?php _e( 'Register', 'bbpress' ); ?></a>
 ...
 global $user_ID;
 if ($user_ID == 1)
	echo "<a href='http://localhost/pcc54/dobavte-novyj-post/' style='position: relative; top: 10px !important;'>Добавить новый пост</a><br/>
	<a href='http://localhost/pcc54/edit-post/dobavte-novyj-post/?edit=".$post->ID."' style='position: relative; top: 10px !important;'>Отредактировать текущий пост</a><br/>
	<a href='http://localhost/pcc54/edit-post/dobavte-novyj-post/?remove=".$post->ID."' style='position: relative; top: 10px !important;'>Удалить текущий пост</a>";
 endif;
