...
//echo "<img src='http://localhost/pcc54/wp-content/uploads/".$photo_list[0]["meta_value"]."'>";
    $html .= sprintf( '<img src="http://localhost/pcc54/wp-content/uploads/'.$photo_list[0]["meta_value"].'" alt="%s"/>', esc_attr( $post->post_title ) );
