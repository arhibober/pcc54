...
<html <?php language_attributes(); ?>>
	<head>
		...
		<?php
			...
			{
				echo "<link href='http://localhost/pcc54/wp-content/themes/DK2/rules_ie.css' rel='stylesheet' type='text/css'/>
				<style>
					td.rc
					{
			...
			if (strstr($_SERVER['HTTP_USER_AGENT'], 'Opera'))
				echo "<link href='http://localhost/pcc54/wp-content/themes/DK2/rules_opera.css' rel='stylesheet' type='text/css'/>";
			else
			if (strstr($_SERVER['HTTP_USER_AGENT'], 'Firefox'))
				echo "<script language='javascript'>
				if (screen.width > 1500)
					document.write (\"<link href='http://localhost/pcc54/wp-content/themes/DK2/rules_firefox_wide.css' rel='stylesheet' type='text/css'/>\");
				else
					document.write (\"<link href='http://localhost/pcc54/wp-content/themes/DK2/rules_firefox_narrow.css' rel='stylesheet' type='text/css'/>\");
				</script>";
			else	
				echo "<link href='http://localhost/pcc54/wp-content/themes/DK2/rules_chrome.css' rel='stylesheet' type='text/css'/>";
