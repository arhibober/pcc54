...
{
echo "<div class='container' style='margin: 0 auto !important; width: 1320 !important;'>";
	echo "<div id='content' style='margin: 0 auto !important;'>
		<div class='row'>
<div style='width: 1120px !important; display: inline !important; float: left !important; position: relative; left: 20px; top: 20px;' valign='top' class='col-sm-3 col-md-3 col-lg-3' id='sidebar'>
		<table align='center'><tr><td valign='top' width='1120'>";
				}
				else
				{				
echo "<div class='container'>";
	...
	echo "<div id='content'>
		<div class='row' style='position: relative !important; top: -50px !important;'>";
			...
			echo "<div class='".shprinkone_get_contentspan()."' style='position: relative; top: -11px;'>
...
if ((strstr($_SERVER['HTTP_USER_AGENT'], 'IE')) && (!strstr($_SERVER['HTTP_USER_AGENT'], 'MSIE 10')))
{
echo "</td><td valign='top' class='rc'>";
...
<div style='position: relative; top: -60px;'>";
				get_sidebar();
					...
					{
					echo "<div style='position: relative !important; top: -38px !important;'>";
...
{
echo "<div class='container' style='margin: 0 auto !important; width: 1320 !important;'>";
	echo "<div id='content' style='margin: 0 auto !important; position: relative; top: 125px !important; left: 85px !important;'>
		<div class='row' style='position: relative !important; top: -130px !important;'>
<div style='width: 1120px !important; display: inline !important; float: left !important; position: relative; left: 20px; top: 20px;' valign='top' class='col-sm-3 col-md-3 col-lg-3' id='sidebar'>
		<table align='center'><tr><td valign='top' width='1120'>";
				}
				else
...
echo "<a href='http://localhost/pcc54/wp-content/uploads/".$photo_list[0]["meta_value"]."'>";?>
								<?php 
										the_post_thumbnail('', array('class' => 'img-responsive'), 300, 400);
										?>
								</a>
...
")))
        ...
        if ( !$errors ) {
            ...
            if ( $post_id ) {
                echo '<div style="position: relative: height: 20px !important; left: 300px !important; top: 2000px !important;">' . __( '<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Пост обновлен успешно.', 'wpuf' ) . '</div>';
