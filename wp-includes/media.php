		...
		if ($avatar > 0)
		{
			echo "<style>
				@media screen and (min-width: 1400px)
				{
					#avatar".$avatar."
					{";					
					if ($width * 255 / 355 > $height)
					    echo "width: 355px !important;
							height: ".$height * 355 / $width."px !important;";
					else
				...
				@media screen and (max-width: 980px)
				{
					#avatar".$avatar."
					{";					
					if ($width * 255 / 275 > $height)
					    echo "width: 275px !important;
							height: ".$height * 275 / $width."px !important;";
					else
						echo "height: 255px !important;
							width: ".$width * 255 / $height."px !important;";
						echo "}			
